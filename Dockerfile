...
RUN --mount=from=packagecache,src=/var/lib/apt,dst=/var/lib/apt,rw \
 ...
 && dpkg -P --force-depends libllvm21 mesa-libgallium fonts-freefont-ttf libgtk-4-1 libgtk-4-common libadwaita-1-0 libc-gconv-modules-extra glycin-loaders libqt5webengine-data xkb-data e2fsprogs libgstreamer1.0-0 libgstreamer-plugins-base1.0-0 libgstreamer-plugins-extra1.0-0 libgstreamer-gl1.0-0 librsvg2-2 \
 ...
 && rm -rf /usr/share/mythtv/themes /usr/share/mythtv/fonts
